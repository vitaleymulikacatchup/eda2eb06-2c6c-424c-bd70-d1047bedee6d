...
export const metadata: Metadata = {
  ...
  description: "Discover expertly crafted specialty coffee in our welcoming cafe. Ethically sourced beans, skilled baristas, and the perfect atmosphere.",
  keywords: ["specialty coffee", "coffee shop", "espresso", "cappuccino", "cafe", "cold brew", "premium coffee"],
  openGraph: {
    title: "Brew Haven - Premium Specialty Coffee",
    description: "Experience excellence in every cup at Brew Haven specialty coffee shop",
    type: "website",
    siteName: "Brew Haven",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763992793267-was1bcmz.jpg",
  ...
  twitter: {
    ...
    title: "Brew Haven - Premium Specialty Coffee Shop",
    description: "Discover expertly crafted specialty coffee and premium atmosphere",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763992793267-was1bcmz.jpg"]
  }
};
